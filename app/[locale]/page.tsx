          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="bg-gray-900 p-4">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <div className="ml-4 text-gray-400 text-sm">
                    <span className="animate-pulse">AI Interview Platform - Live Demo</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-6">
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold text-gray-900">
                      <span className="animate-pulse">Interview Dashboard</span>
                    </h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-3xl font-bold text-gray-900">
                            ...
                            <span className="text-green-500 ml-2 animate-bounce">↗</span>
                          </p>
                        </div>
                        <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center animate-spin">
                    ...
                    <div className="bg-green-50 p-6 rounded-xl animate-pulse" style={{animationDelay: '0.5s'}}>
                      <div className="flex items-center justify-between">
                        <div>
                        ...
                        <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center animate-spin" style={{animationDelay: '0.5s'}}>
                    ...
                    <div className="bg-purple-50 p-6 rounded-xl animate-pulse" style={{animationDelay: '1s'}}>
                      <div className="flex items-center justify-between">
                        <div>
                        ...
                        <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center animate-spin" style={{animationDelay: '1s'}}>
                  ...
                  <div className="mb-8">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">AI Processing Status</h3>
                    <div className="space-y-4">
                      <div className="bg-gray-200 rounded-full h-3 overflow-hidden">
                        <div className="bg-blue-500 h-full rounded-full animate-pulse" style={{width: '85%', animation: 'progressBar 3s ease-in-out infinite'}}></div>
                      </div>
                      ...
                      <div className="bg-gray-200 rounded-full h-3 overflow-hidden">
                        <div className="bg-green-500 h-full rounded-full animate-pulse" style={{width: '92%', animation: 'progressBar 3s ease-in-out infinite 0.5s'}}></div>
                      </div>
                      <div className="flex justify-between text-sm text-gray-600">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-600 animate-pulse">Live</span>
                      </div>
                    </div>
                    
                    <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm">
                      <div className="text-green-400 mb-2 animate-pulse">// Candidate: John Smith - Senior Developer</div>
                      <div className="text-blue-400 mb-2 animate-pulse" style={{animationDelay: '0.5s'}}>function findMaxNumber(arr) {'{'}</div>
                      <div className="text-white ml-4 mb-2 animate-pulse" style={{animationDelay: '1s'}}>let max = arr[0];</div>
                      <div className="text-white ml-4 mb-2 animate-pulse" style={{animationDelay: '1.5s'}}>for (let i = 1; i {'<'} arr.length; i++) {'{'}</div>
                      <div className="text-white ml-8 mb-2 animate-pulse" style={{animationDelay: '2s'}}>if (arr[i] {'>'} max) {'{'}</div>
                      <div className="text-white ml-12 mb-2 animate-pulse" style={{animationDelay: '2.5s'}}>max = arr[i];</div>
                      <div className="text-white ml-8 mb-2 animate-pulse" style={{animationDelay: '3s'}}>{'}'}</div>
                      <div className="text-white ml-4 mb-2 animate-pulse" style={{animationDelay: '3.5s'}}>{'}'}</div>
                      <div className="text-white ml-4 mb-2 animate-pulse" style={{animationDelay: '4s'}}>return max;</div>
                      <div className="text-blue-400 animate-pulse" style={{animationDelay: '4.5s'}}>{'}'}</div>
                      <div className="text-gray-400 mt-2 animate-pulse" style={{animationDelay: '5s'}}>// AI Analysis: Code quality 95% ✅</div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 animate-pulse">AI is analyzing candidate performance...</p>
                        <p className="text-xs text-gray-600 animate-pulse">Real-time insights and recommendations</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-20 hover:bg-opacity-30 transition-all duration-300 cursor-pointer group">
                <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 animate-pulse">
                  <svg className="w-8 h-8 text-blue-600 ml-1 animate-bounce" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center mt-8">
              ...
              <button className="mt-4 text-blue-600 font-semibold hover:text-blue-700 transition-colors animate-bounce">
                Watch Full Demo →
              </button>
            </div>
          </div>
